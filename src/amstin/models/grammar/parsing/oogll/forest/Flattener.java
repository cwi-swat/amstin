...
import amstin.models.grammar.parsing.oogll.sppf.INode;
...
import amstin.models.grammar.parsing.oogll.symbol.Iter;
import amstin.models.grammar.parsing.oogll.symbol.IterSep;
import amstin.models.grammar.parsing.oogll.symbol.IterSepStar;
import amstin.models.grammar.parsing.oogll.symbol.IterStar;
import amstin.models.grammar.parsing.oogll.symbol.Opt;
...
public class Flattener {
	...
	private Set<List<Tree>> flattenRegular(Tree t, IdentityHashMap<Tree, Tree> done) {
		...
		if (t instanceof Symbol && ((Symbol)t).getSymbol() instanceof Regular) {
			...
			amstin.models.grammar.parsing.oogll.symbol.Symbol s = sn.getSymbol();
